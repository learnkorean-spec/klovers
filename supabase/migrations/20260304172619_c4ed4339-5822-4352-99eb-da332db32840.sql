-- Fix: Add UNDER_REVIEW to allowed approval_status values in validate_enrollment_status trigger
...
BEGIN
  ...
  END IF;
  IF NEW.approval_status NOT IN ('PENDING','APPROVED','REJECTED','PENDING_PAYMENT','UNDER_REVIEW','pending','approved','rejected','pending_payment','under_review') THEN
