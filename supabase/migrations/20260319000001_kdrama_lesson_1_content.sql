...
BEGIN
  ...
  (l_id, '안녕하세요',           'annyeonghaseyo',              'Hello / How do you do? (polite)',           1),
  (l_id, '만나서 반갑습니다',    'mannaseo bangapseumnida',     'Nice to meet you (formal)',                  2),
  (l_id, '처음 뵙겠습니다',      'cheoeum boepgesseumnida',     'Nice to meet you for the first time (very formal)', 3),
  (l_id, '저는 ~입니다',         'jeoneun ~imnida',             'I am ~ (formal self-introduction)',         4),
  (l_id, '이름',                 'ireum',                       'name',                                      5),
  (l_id, '성함',                 'seongham',                    'name (honorific form)',                     6),
  (l_id, '잘 부탁드립니다',      'jal butakdeurimnida',         'Please take care of me (set phrase)',        7),
  (l_id, '소개하다',             'sogaehada',                   'to introduce',                              8),
  (l_id, '인사하다',             'insahada',                    'to greet',                                  9),
  (l_id, '처음',                 'cheoeum',                     'first time',                                10),
  (l_id, '반갑다',               'bangapda',                    'to be pleased / glad to meet',              11),
  (l_id, '선배',                 'seonbae',                     'senior (at work or school)',                12),
  (l_id, '후배',                 'hubae',                       'junior (at work or school)',                13),
  (l_id, '동료',                 'dongnyeo',                    'colleague',                                 14),
  (l_id, '명함',                 'myeongham',                   'business card',                             15),
  (l_id, '어디서 오셨어요?',     'eodiseo osyeosseoyo?',        'Where are you from?',                       16),
  (l_id, '직업',                 'jigeop',                      'job / occupation',                          17),
  (l_id, '눈이 마주치다',        'nuni majuchida',              'eyes to meet (classic K-drama moment)',     18),
  (l_id, '운명',                 'unmyeong',                    'fate / destiny',                            19),
  (l_id, '반갑습니다',           'bangapseumnida',              'Nice to meet you / I am glad (formal)',     20);
  ...
  (l_id, '수진', '실례합니다. 저 오늘부터 여기서 일하게 된 김수진입니다.',
