...
-- Uses string_to_array for reliable word counting across all languages
...
UPDATE blog_posts SET seo_score = LEAST(100,
  ...
  -- Content: exists (5) + word count via space split: 800+ (15) or 300+ (10) or 100+ (5) + has headings (5)
