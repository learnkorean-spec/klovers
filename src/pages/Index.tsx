        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-500 text-white">
          <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-center">
            ...
            <Link
              ...
              className="inline-flex items-center gap-1.5 bg-white text-indigo-700 text-xs font-semibold px-4 py-1.5 rounded-full hover:bg-indigo-50 transition-colors"
            >
