  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        ...
        <div className="absolute -bottom-20 -end-20 w-64 h-64 bg-green-200/20 dark:bg-green-800/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="text-center mb-12">
          <Badge
            variant="outline"
            className={`mb-4 border-emerald-400/60 text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/30 transition-all duration-700 ${
        ...
        >
          <Card className="border-2 border-emerald-300/60 dark:border-emerald-700/40 bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-950/30 dark:to-green-950/20 shadow-lg">
            <CardContent className="pt-8 pb-8">
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 dark:text-emerald-300 mb-4">
              ...
              <div className="grid sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
                {referralItems.map((item, i) => {
                  ...
                  return (
                    <div key={i} className="text-center p-4 rounded-xl bg-white/60 dark:bg-emerald-900/20 border border-emerald-200/40 dark:border-emerald-800/30">
                      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-800/50 text-emerald-600 dark:text-emerald-300 mb-3">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            {/* Promo code block */}
            <Card className="border-2 border-dashed border-emerald-400/60 bg-emerald-50/50 dark:bg-emerald-950/20">
                ...
                return (
                  <div key={i} className="flex items-start gap-4">
                    <div className="flex flex-col items-center">
                      ...
                      {i < steps.length - 1 && (
                        <div className="w-0.5 h-6 bg-emerald-300/40 dark:bg-emerald-700/40 mt-1" />
                      )}
                    </div>
                ...
                >
                  ...
                  <div
                    className={`px-4 text-sm text-muted-foreground overflow-hidden transition-all duration-200 ${
                      openFaq === i ? "py-3 border-t border-emerald-200/40 dark:border-emerald-800/30" : "max-h-0 py-0"
                    }`}
                  >
                    {faq.answer}
                  </div>
        ...
        >
          <Button size="lg" asChild className="gap-2 h-13 px-8 text-base font-bold shadow-lg bg-emerald-600 hover:bg-emerald-700">
