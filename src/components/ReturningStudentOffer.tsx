          ...
          <Card className="border-2 border-primary/30 dark:border-primary/20 bg-muted/50 shadow-lg">
            <CardContent className="pt-8 pb-8">
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-primary/10 dark:bg-primary/5 text-primary dark:text-primary mb-4">
                ...
                {referralItems.map((item, i) => {
                  ...
                  return (
                    <div key={i} className="text-center p-4 rounded-xl bg-white/60 dark:bg-muted/30 border border-border/60">
                      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-primary/10 dark:bg-primary/5 text-primary dark:text-primary mb-3">
                ...
                return (
                  <div key={i} className="flex items-start gap-4">
                    <div className="flex flex-col items-center">
                      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-primary/10 dark:bg-primary/5 text-foreground font-bold text-sm border-2 border-border">
                        {i + 1}
                      </span>
                      {i < steps.length - 1 && (
