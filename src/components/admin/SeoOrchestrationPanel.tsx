...
import { Loader2, Play, Wrench, CheckCircle, AlertCircle, ChevronDown, ChevronRight, Sparkles } from "lucide-react";
      ...
      {summary && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            { label: "AI Calls Made", value: summary.ai_calls_made },
            { label: "Avg SEO Score", value: summary.avg_seo_score != null ? `${summary.avg_seo_score}/10` : "—" },
          ].map(({ label, value }) => (
