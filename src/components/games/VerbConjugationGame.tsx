...
const Verb{ onGameComplete }: { onGameComplete?: (score: number, total: number) => void }ConjugationGame = () => {
  ...
  if (round >= totalRounds) {
    return (
      <section className="py-12 px-4"><Card className="max-w-lg mx-auto p-8 text-center space-y-4">
        ...
        <h2 className="text-2xl font-bold text-foreground">Verb Mastery!</h2>
    ...
    <section className="py-12 px-4">
      <div className="max-w-lg mx-auto space-y-6">
        ...
        <Card className="p-6 text-center space-y-4">
          <p className="text-sm text-muted-foreground">Conjugate this verb:</p>
